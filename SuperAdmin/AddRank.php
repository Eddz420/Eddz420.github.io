...
<form action="" method="post">
    ...
    <center><div style="color : red;text-shadow: 1px 1px grey;font-family:monospace; font-size:30px;font-weight:1000;">Add a Rank</div></center>
<?php 
    ...
    <table>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <input class="w3-input d" type="text" name="rank" placeholder="rank" required="" >
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <input class="w3-input d" type="text" name="rankName" placeholder="Rank Name" required="" >
...
//---------------------------------------------- Retirer Classe ---------------------------------------
        ...
        if(isset($_POST['Add'])) {
            ...
            $color2=$_POST['color']; 
                ...
                $sql="INSERT INTO `rank`( `rank`, `rankName`, `color`) VALUES ('".$rank2."','".$rankname2."','".$color2."');";
            if(mysqli_query($connect,$sql)){
                $_SESSION['Msg']="<a style='color:#00b000;text-shadow: 1px 1px black;font-weight:1000;font-size:20px;font-family: monospace;'>a new Rank has been Added!</a>";
