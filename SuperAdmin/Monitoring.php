...
<a href="#section2" style="margin-left: 58%;margin-top: -50px; position: absolute;"><button class="myButton green" >Actions</button></a>
          ...
          <table class='styled-table'>
            ...
            <?php  
                    ...
                    try {
					    ...
					    $sql ="SELECT * FROM `members` m, Points p WHERE m.id_Member LIKE p.id_Member ORDER BY Points DESC";
                             ...
                             while($row=mysqli_fetch_array($result)){
                                ...
                                if($points==0){
                                  ...
                                  echo "<tr>";
                                    ...
                                    echo"   <th><a style='text-shadow: .5px .5px black;".$color."'>".$points;"</a></th>";

                                    echo"<th><button type='submit' value='$idP' name ='Modify' class='myButton green' >Edit</button>&nbsp;
                        ...
                        }else{echo "<tr><td colspan='3'><center>There are no members in this Crew</center></td></tr>";}
...
<div style="color : red;text-shadow: 1px 1px grey;font-family:monospace; font-size:30px;font-weight:1000;">Actions</div>
...
<table class='styled-table'>
            ...
            <?php  
                    ...
                    try {
                        ...
                        $sql ="SELECT * FROM `Action` ORDER BY `Pointing` DESC";
                        ...
                        if(mysqli_fetch_array($result2)){                     
                             ...
                             while($row=mysqli_fetch_array($result)){
                                ...
                                echo "<tr>";
                                    ...
                                    echo    "<th><a style='font-size:17px;;'>".$id_Action;"</a></th>";

                                    echo    "<td style='align-text:left;'><a style='font-size:17px;'>".$Action;"</a></td>";

                                    echo    "<td ><a style='font-size:17px;".$color2."'><center>".$Pointing;"</center></a></td>";
                                    echo    "<td>
                                                <button type='submit' value='$id_Action' name ='Modify' class='myButton green' >Edit</button>&nbsp;
                                                <button type='submit' value='$id_Action' name ='Delete' class='myButton red' >Delete</button>
                                            </td>";//buttons
                        ...
                        }else{echo "<tr><th colspan='2'><center>No Actions were added!</center></th></tr>";}
